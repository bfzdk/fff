...
BikerWeedFarm = {
	...
	Security = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerWeedFarm.interiorId,
				{ BikerWeedFarm.Security.basic, BikerWeedFarm.Security.upgrade },
				false,
				refresh
			)
		end,
	...
	Plant1 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant1.Stage.small, BikerWeedFarm.Plant1.Stage.medium, BikerWeedFarm.Plant1.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant1.Light.basic, BikerWeedFarm.Plant1.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	Plant2 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant2.Stage.small, BikerWeedFarm.Plant2.Stage.medium, BikerWeedFarm.Plant2.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant2.Light.basic, BikerWeedFarm.Plant2.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	Plant3 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant3.Stage.small, BikerWeedFarm.Plant3.Stage.medium, BikerWeedFarm.Plant3.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant3.Light.basic, BikerWeedFarm.Plant3.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	Plant4 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant4.Stage.small, BikerWeedFarm.Plant4.Stage.medium, BikerWeedFarm.Plant4.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant4.Light.basic, BikerWeedFarm.Plant4.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	Plant5 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant5.Stage.small, BikerWeedFarm.Plant5.Stage.medium, BikerWeedFarm.Plant5.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant5.Light.basic, BikerWeedFarm.Plant5.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	Plant6 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant6.Stage.small, BikerWeedFarm.Plant6.Stage.medium, BikerWeedFarm.Plant6.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant6.Light.basic, BikerWeedFarm.Plant6.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	Plant7 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant7.Stage.small, BikerWeedFarm.Plant7.Stage.medium, BikerWeedFarm.Plant7.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant7.Light.basic, BikerWeedFarm.Plant7.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	Plant8 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant8.Stage.small, BikerWeedFarm.Plant8.Stage.medium, BikerWeedFarm.Plant8.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant8.Light.basic, BikerWeedFarm.Plant8.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	Plant9 = {
		Stage = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant9.Stage.small, BikerWeedFarm.Plant9.Stage.medium, BikerWeedFarm.Plant9.Stage.full },
					false,
					refresh
				)
			end,
		...
		Light = {
			...
			Clear = function(refresh)
				SetIplPropState(
					BikerWeedFarm.interiorId,
					{ BikerWeedFarm.Plant9.Light.basic, BikerWeedFarm.Plant9.Light.upgrade },
					false,
					refresh
				)
			end,
	...
	LoadDefault = function()
		...
		BikerWeedFarm.Details.Enable(
			{ BikerWeedFarm.Details.production, BikerWeedFarm.Details.chairs, BikerWeedFarm.Details.drying },
			true
		)
