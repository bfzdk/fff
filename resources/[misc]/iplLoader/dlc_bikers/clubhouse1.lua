...
BikerClubhouse1 = {
	...
	Walls = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Walls.brick, BikerClubhouse1.Walls.plain },
				false,
				refresh
			)
		end,
	...
	Furnitures = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Furnitures.A, BikerClubhouse1.Furnitures.B },
				false,
				refresh
			)
		end,
	...
	Decoration = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Decoration.A, BikerClubhouse1.Decoration.B },
				false,
				refresh
			)
		end,
	...
	GunLocker = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.GunLocker.on, BikerClubhouse1.GunLocker.off },
				false,
				refresh
			)
		end,
	...
	ModBooth = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.ModBooth.on, BikerClubhouse1.ModBooth.off },
				false,
				refresh
			)
		end,
	...
	Meth = {
		none = "",
		stage1 = "meth_stash1",
		stage2 = { "meth_stash1", "meth_stash2" },
		stage3 = { "meth_stash1", "meth_stash2", "meth_stash3" },
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Meth.stage1, BikerClubhouse1.Meth.stage2, BikerClubhouse1.Meth.stage3 },
				false,
				refresh
			)
		end,
	...
	Cash = {
		none = "",
		stage1 = "cash_stash1",
		stage2 = { "cash_stash1", "cash_stash2" },
		stage3 = { "cash_stash1", "cash_stash2", "cash_stash3" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Cash.stage1, BikerClubhouse1.Cash.stage2, BikerClubhouse1.Cash.stage3 },
				false,
				refresh
			)
		end,
	...
	Weed = {
		none = "",
		stage1 = "weed_stash1",
		stage2 = { "weed_stash1", "weed_stash2" },
		stage3 = { "weed_stash1", "weed_stash2", "weed_stash3" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Weed.stage1, BikerClubhouse1.Weed.stage2, BikerClubhouse1.Weed.stage3 },
				false,
				refresh
			)
		end,
	...
	Coke = {
		none = "",
		stage1 = "coke_stash1",
		stage2 = { "coke_stash1", "coke_stash2" },
		stage3 = { "coke_stash1", "coke_stash2", "coke_stash3" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Coke.stage1, BikerClubhouse1.Coke.stage2, BikerClubhouse1.Coke.stage3 },
				false,
				refresh
			)
		end,
	...
	Counterfeit = {
		...
		stage2 = { "counterfeit_stash1", "counterfeit_stash2" },
		stage3 = { "counterfeit_stash1", "counterfeit_stash2", "counterfeit_stash3" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Counterfeit.stage1, BikerClubhouse1.Counterfeit.stage2, BikerClubhouse1.Counterfeit.stage3 },
				false,
				refresh
			)
		end,
	...
	Documents = {
		none = "",
		stage1 = "id_stash1",
		stage2 = { "id_stash1", "id_stash2" },
		stage3 = { "id_stash1", "id_stash2", "id_stash3" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse1.interiorId,
				{ BikerClubhouse1.Documents.stage1, BikerClubhouse1.Documents.stage2, BikerClubhouse1.Documents.stage3 },
				false,
				refresh
			)
		end,
