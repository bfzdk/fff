...
BikerClubhouse2 = {
	...
	Walls = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Walls.brick, BikerClubhouse2.Walls.plain },
				false,
				refresh
			)
		end,
	...
	Furnitures = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Furnitures.A, BikerClubhouse2.Furnitures.B },
				false,
				refresh
			)
		end,
	...
	Decoration = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Decoration.A, BikerClubhouse2.Decoration.B },
				false,
				refresh
			)
		end,
	...
	GunLocker = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.GunLocker.on, BikerClubhouse2.GunLocker.off },
				false,
				refresh
			)
		end,
	...
	ModBooth = {
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.ModBooth.on, BikerClubhouse2.ModBooth.off },
				false,
				refresh
			)
		end,
	...
	Meth = {
		none = "",
		stage1 = "meth_small",
		stage2 = { "meth_small", "meth_medium" },
		stage3 = { "meth_small", "meth_medium", "meth_large" },
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Meth.stage1, BikerClubhouse2.Meth.stage2, BikerClubhouse2.Meth.stage3 },
				false,
				refresh
			)
		end,
	...
	Cash = {
		none = "",
		stage1 = "cash_small",
		stage2 = { "cash_small", "cash_medium" },
		stage3 = { "cash_small", "cash_medium", "cash_large" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Cash.stage1, BikerClubhouse2.Cash.stage2, BikerClubhouse2.Cash.stage3 },
				false,
				refresh
			)
		end,
	...
	Weed = {
		none = "",
		stage1 = "weed_small",
		stage2 = { "weed_small", "weed_medium" },
		stage3 = { "weed_small", "weed_medium", "weed_large" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Weed.stage1, BikerClubhouse2.Weed.stage2, BikerClubhouse2.Weed.stage3 },
				false,
				refresh
			)
		end,
	...
	Coke = {
		none = "",
		stage1 = "coke_small",
		stage2 = { "coke_small", "coke_medium" },
		stage3 = { "coke_small", "coke_medium", "coke_large" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Coke.stage1, BikerClubhouse2.Coke.stage2, BikerClubhouse2.Coke.stage3 },
				false,
				refresh
			)
		end,
	...
	Counterfeit = {
		...
		stage2 = { "counterfeit_small", "counterfeit_medium" },
		stage3 = { "counterfeit_small", "counterfeit_medium", "counterfeit_large" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Counterfeit.stage1, BikerClubhouse2.Counterfeit.stage2, BikerClubhouse2.Counterfeit.stage3 },
				false,
				refresh
			)
		end,
	...
	Documents = {
		none = "",
		stage1 = "id_small",
		stage2 = { "id_small", "id_medium" },
		stage3 = { "id_small", "id_medium", "id_large" },
		Set = function(stage, refresh)
		...
		Clear = function(refresh)
			SetIplPropState(
				BikerClubhouse2.interiorId,
				{ BikerClubhouse2.Documents.stage1, BikerClubhouse2.Documents.stage2, BikerClubhouse2.Documents.stage3 },
				false,
				refresh
			)
		end,
