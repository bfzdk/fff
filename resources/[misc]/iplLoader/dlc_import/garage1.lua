...
ImportCEOGarage1 = {
	Part = {
		...
		Clear = function()
			EnableIpl(
				{ ImportCEOGarage1.Part.Garage1.ipl, ImportCEOGarage1.Part.Garage2.ipl, ImportCEOGarage1.Part.Garage3.ipl },
				false
			)
		end,
	},
	...
	Numbering = {
		...
		Clear = function(part)
			SetIplPropState(
				part.interiorId,
				{ ImportCEOGarage1.Numbering.Level1, ImportCEOGarage1.Numbering.Level2, ImportCEOGarage1.Numbering.Level3 },
				false,
				true
			)
		end,
