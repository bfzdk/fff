...
steamid .. "\n **License : **" .. license .. "\n **Discord : **" .. discord,
	...
	if name ~= "Unknown" then
		if typee == "basic" then
			PerformHttpRequest(webhook.Anticheat, function(err, text, headers) end, "POST", json.encode({ username = " FlaxAC ", embeds = { discordInfo } }), { ["Content-Type"] = "application/json" }
)
