...
function vRP.setHunger(user_id, value)
	...
	if data then
		...
		vRPclient.setProgressBarValue(source, { "hunger", data.hunger })
	end
end
...
function vRP.setThirst(user_id, value)
	...
	if data then
		...
		-- update bar
		local source = vRP.getUserSource(user_id)
		vRPclient.setProgressBarValue(source, { "thirst", data.thirst })
	end
end
function vRP.varyHunger(user_id, variation)
	...
	if data then
		...
		local source = vRP.getUserSource(user_id)
		vRPclient.setProgressBarText(source, { "hunger", data.hunger })
	end
end
...
function vRP.varyThirst(user_id, variation)
	...
	if data then
		...
		-- set progress bar data
		local source = vRP.getUserSource(user_id)
		vRPclient.setProgressBarText(source, { "thirst", data.thirst })
	end
end
