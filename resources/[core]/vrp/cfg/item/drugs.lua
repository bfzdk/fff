...
items["pills"] = {
	"Smertestillende",
	"En Smertestillende pille",
	function(args)
		return pills_choices
	end,
	0.1,
}
items["joint"] = {
...
items["sblomst"] = {
	"Sjælden blomster",
	"Ulovligt! Sjælden blomst godt fundet",
	function(args)
		return sblomst_choices
	end,
	0.01,
}
items["kblomst"] = {
	"Kogte blomster",
	"Ulovligt! Kan sælges senere hen",
	function(args)
		return kblomst_choices
	end,
	0.01,
}
items["ssblomst"] = {
