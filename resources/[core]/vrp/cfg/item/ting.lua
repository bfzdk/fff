...
pakkeryge_choices["> Tag cigaretter"] = {
...
puzzlespil1_choices["> Udpak puzzlespil 1/4"] = {
	function(player, choice)
		local user_id = vRP.getUserId(player)
		if user_id ~= nil then
...
puzzlespil2_choices["> Udpak puzzlespil 2/4"] = {
	function(player, choice)
		local user_id = vRP.getUserId(player)
		if user_id ~= nil then
...
puzzlespil3_choices["> Udpak puzzlespil 3/4"] = {
	function(player, choice)
		local user_id = vRP.getUserId(player)
		if user_id ~= nil then
...
puzzlespil4_choices["> Udpak puzzlespil 4/4"] = {
	function(player, choice)
		local user_id = vRP.getUserId(player)
		if user_id ~= nil then
...
items["cigaretpakke"] = {
	"Prince Light",
	"En vanedannende cigaretter",
	function(args)
		return pakkeryge_choices
	end,
	0.21,
}
items["hammer"] = {
	"Hammer",
	"En håndværker hammer. Til fx. Tømrearbejde.",
	function(args)
		return hammer_choices
	end,
	0.4,
}
items["kamera"] = {
	"Kamera",
	"Et godt kamera der tager gode billeder.",
	function(args)
		return kamera_choices
	end,
	0.2,
}
items["fiskestang"] = {
	"Fiskestang",
	"En fiskestang til at fiske med.",
	function(args)
		return fiske_choices
	end,
	1,
	2,
}
items["guitar"] = {
	"Guitar",
	"En guitar, giver du koncert?",
	function(args)
		return guitar_choices
	end,
	1,
}
items["kort"] = {
...
items["puzzlespil1"] = {
	"Puzzlespil 1/4",
	"Har du lyst til at lægge et puzzlespil?",
	function(args)
		return puzzlespil1_choices
	end,
	0.1,
}
items["puzzlespil2"] = {
...
items["puzzle_6"] = {
	"Ledetråde 6 - 1/4",
	"Jeg tror jeg bliver rigtig våd hvis jeg vil væk...... Burde jeg have husket vandtæt tøj????",
	nil,
	0.1,
}
...
items["puzzle_6_2"] =
	{ "Ledetråde 6 - 2/4", "Glemte jeg at sige du skal bruge en nøgle Veeent forkert puzzlespil", nil, 0.1 }
...
items["puzzle_1_3"] =
	{ "Ledetråde 1 - 3/4", "Inden man køre ind står der noget med d..n.t. v...a..? Hvad skal det mon betyde", nil, 0.1 }
...
items["puzzle_5_3"] = {
	"Ledetråde 5 - 3/4",
	"Har du husket at købe olie? og gas? du skal jo bruge noget til at starte kogepladen med",
	nil,
	0.1,
}
items["puzzle_6_3"] = { "Ledetråde 6 - 3/4", "Tror der er en butik i paleto der sælger gas og olie", nil, 0.1 }
items["puzzle_7_3"] =
	{ "Ledetråde 7 - 3/4", "Men pas på tror det var noget med at politiet tit er i området", nil, 0.1 }
...
items["puzzle_7_4"] =
	{ "Ledetråde 7 - 4/4", "Har du husket at købe en kniv i bilka ellers kan du jo ikke hakke det", nil, 0.1 }
