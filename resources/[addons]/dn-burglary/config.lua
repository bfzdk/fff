...
Permission = 'police.pc',  -- Permission til politiet til at tjekke hvor mange betjente der er online

minCops = 0, -- Minimum antal betjente

progress = 'progressBars', -- Progressbar export

Cooldown = 480, -- Nedkølingstid efter et indbrud

Lang = {
    ['lockpick_door_notify']    = 'Dirker Lås',
    ['lockpick_door']         	= 'Dirker Lås...',
    ['lockpick_broke']          = 'Indbrud fejlet din lockpick knækkede',
    ['search_storage']         	= 'Leder...',
    ['cooldown_message']        = 'Du har for nyligt røvet, hold lav profil',
    ['police_nearby']           = 'Der er for mange betjente i området',
    ['leave_house']             = '~g~[E]~w~ - Forlad',
    ['search_storage3D']        = '~g~[E]~w~ - Undersøg',
...
rewarditems = {
	{name = 'kebab', quantity = 50},
	{name = 'water', quantity = 50},
	{name = 'kokain', quantity = 3},
	{name = 'suppressor', quantity = 1},
	{name = 'iphone', quantity = 10},
	{name = 'kokainblade', quantity = 800},
	{name = 'strips', quantity = 50},
	{name = 'lockpick', quantity = 1},
	{name = 'lsd', quantity = 250},
	{name = 'lsd', quantity = 500},
	{name = 'kokain', quantity = 500},
	{name = 'kokain', quantity = 250},
	{name = 'kebab', quantity = 50},
	{name = 'water', quantity = 50},
	{name = 'kokain', quantity = 3},
	{name = 'suppressor', quantity = 1},
	...
	{name = 'kokain', quantity = 500},
	{name = 'kokain', quantity = 250},
	{name = 'wbody|WEAPON_MINISMG', quantity = 1},
	{name = 'wbody|WEAPON_PISTOL', quantity = 1},
	{name = 'wbody|WEAPON_SNSPISTOL', quantity = 1},
	{name = 'wbody|WEAPON_PISTOL', quantity = 1},
	{name = 'wbody|WEAPON_PISTOL50', quantity = 1},
	{name = 'wbody|WEAPON_HEAVYPISTOL', quantity = 1},
	{name = 'wammo|WEAPON_MINISMG', quantity = 250},
	{name = 'wammo|WEAPON_PISTOL', quantity = 250},
	{name = 'wammo|WEAPON_SNSPISTOL', quantity = 250},
	{name = 'wammo|WEAPON_PISTOL', quantity = 250},
	{name = 'wammo|WEAPON_PISTOL50', quantity = 250},
	{name = 'wammo|WEAPON_HEAVYPISTOL', quantity = 250},
},
...
robbableHouses = {
    ...
    [83] = {x = 130.31, y = -1959.0, z = 25.13, info = 'Grove Street 11'},
