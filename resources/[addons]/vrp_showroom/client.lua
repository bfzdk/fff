			...
			buttons = {
				{
					name = "Mercedes GT 63",
					costs = 0,
					description = { "Find en bilforhandler for at købe denne bil" },
					model = "rmodgt63",
				},
				{
...
local vehshop_locations = {
	{
		entering = { -34.106288909912, -1102.6079101563, 25.422351837158 },
		inside = { -46.56327, -1097.382, 25.99875, 120.1953 },
		outside = { -15.97952747345, -1101.6713867188, 26.676162719727 },
	},
}
		...
		Citizen.CreateThread(function()
			while #vehshop_blips > 0 do
				...
				for i, b in ipairs(vehshop_blips) do
					if
						IsPlayerWantedLevelGreater(GetPlayerIndex(), 0) == false
						and vehshop.opened == false
						and IsPedInAnyVehicle(vehSR_LocalPed(), true) == false
						and GetDistanceBetweenCoords(
								b.pos.entering[1],
								b.pos.entering[2],
								b.pos.entering[3],
								GetEntityCoords(vehSR_LocalPed())
							)
							< 2
					then
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if vehshop.opened then
			...
			vehSR_drawTxt(
				vehshop.selectedbutton .. "/" .. vehSR_tablelength(menu.buttons),
				0,
				0,
				vehshop.menu.x + vehshop.menu.width / 2 - 0.0385,
				vehshop.menu.y + 0.067,
				0.4,
				255,
				255,
				255,
			...
			for i, button in pairs(menu.buttons) do
				if i >= vehshop.menu.from and i <= vehshop.menu.to then
					...
					if button.costs ~= nil then
						if
							vehshop.currentmenu == "Kompakte"
							or vehshop.currentmenu == "Eksklusiv"
							or vehshop.currentmenu == "Coupéer"
							or vehshop.currentmenu == "Sedan"
							or vehshop.currentmenu == "Sports"
							or vehshop.currentmenu == "Sport klassikere"
							or vehshop.currentmenu == "Supers"
							or vehshop.currentmenu == "Muskel"
							or vehshop.currentmenu == "Offroad"
							or vehshop.currentmenu == "SUVer"
							or vehshop.currentmenu == "Varevogne"
							or vehshop.currentmenu == "Import - Find bilforhandler"
							or vehshop.currentmenu == "industrial"
							or vehshop.currentmenu == "cycles"
							or vehshop.currentmenu == "Motorcykler"
						then
...
function vehSR_ButtonSelected(button)
	...
	elseif
		...
		or this == "Sedan"
		or this == "Sports"
		or this == "Sport klassikere"
		or this == "Supers"
		or this == "Muskel"
		or this == "Offroad"
		or this == "SUVer"
		or this == "Varevogne"
		or this == "Import - Find bilforhandler"
		or this == "industrial"
	then
