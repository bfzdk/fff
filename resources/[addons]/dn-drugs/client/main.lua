...
local tvRP = vRP.tunnel.getInterface()
...
Citizen.CreateThread(function()
	while true do
		...
		for _, sted in pairs(kokain) do
			local distance =
				GetDistanceBetweenCoords(sted.x, sted.y, sted.z, plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
			if distance <= 1 then
...
Citizen.CreateThread(function()
	while true do
		...
		if
			GetDistanceBetweenCoords(1392.3264160156, 3605.9270019531, 38.94193649292, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(-1622.6534423828, -994.30645751953, 7.6779065132141, GetEntityCoords(GetPlayerPed(-1)))
			< 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(2432.9777832031, 4969.4848632813, 43.400890350342, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(225.25419616699, -1982.4621582031, 19.746425628662, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(2356.5842285156, 3131.6752929688, 48.208595275879, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(-1564.3973388672, -3235.8251953125, 26.336153030396, GetEntityCoords(GetPlayerPed(-1)))
			< 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(3559.2905273438, 3672.0979003906, 28.12188911438, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(1092.9554443359, -3194.8947753906, -38.993473052979, GetEntityCoords(GetPlayerPed(-1)))
			< 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(-2036.3176269531, -1033.9346923828, 5.8823590278625, GetEntityCoords(GetPlayerPed(-1)))
			< 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(1443.0721435547, 6332.310546875, 23.981895446777, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		if
			GetDistanceBetweenCoords(-2.1932320594788, 6653.5297851563, 31.208330154419, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(1296.9281005859, 1453.1201171875, 99.449394226074, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(1122.6550292969, -3196.8559570313, -40.396881103516, GetEntityCoords(GetPlayerPed(-1)))
			< 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(1087.8718261719, -2001.8940429688, 30.87518119812, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(107.78172302246, -934.28332519532, 29.774265289306, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(1085.0635986328, -2002.1551513672, 31.429588317871, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(109.35730743408, -929.24609375, 29.8268699646, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(1087.7242431641, -2004.9129638672, 31.153045654297, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(105.80088043213, -938.52996826172, 29.736600875854, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		if
			GetDistanceBetweenCoords(1109.9221191406, -2008.1363525391, 31.058889389038, GetEntityCoords(GetPlayerPed(-1))) < 5.0
		then
...
Citizen.CreateThread(function()
	while true do
		...
		local coord = GetEntityCoords(player)
		if
			GetDistanceBetweenCoords(-622.01745605468, -230.66743469238, 38.057067871094, GetEntityCoords(GetPlayerPed(-1)))
			< 5.0
		then
