...
local atms = {
	...
	{ name = "Hæveautomat", id = 0, x = 315.2200012207, y = -593.72497558594, z = 43.283992767334 },
}
-- Banks
local banks = {
	{ name = "Midtby Bank", id = 374, x = 150.266, y = -1040.203, z = 29.374 },
	{ name = "Sydbank", id = 374, x = -1212.980, y = -330.841, z = 37.787 },
	{ name = "Nordea Bank", id = 374, x = -2962.582, y = 482.627, z = 15.703 },
	{ name = "Blaine County Savings", id = 374, x = -112.202, y = 6469.295, z = 31.626 },
	{ name = "Alm. Brand Bank", id = 374, x = 314.187, y = -278.621, z = 54.170 },
	...
	{ name = "Fleeca Bank", id = 374, x = 255.001098632813, y = 225.855895996094, z = 101.005694274902 },
}
...
AddEventHandler("bank:debt", function(amount)
	if IsNearATM() == true or IsNearBank() == true or withdrawAnywhere == true then
		...
		TriggerEvent(
			"pNotify:SendNotification",
			{
				text = "Dette er ikke en bank eller hæveautomat",
				type = "error",
				timeout = 4000,
				layout = "bottomCenter",
				queue = "global",
