...
function Menu:setTitle(options)
	...
	DrawText(options.x, options.y + 0.040)
end

function Menu:setSubTitle(options)
	SetTextFont(0)
	SetTextProportional(0)
	SetTextScale(options.scale - 0.0, options.scale - 0.0)
	SetTextColour(255, 255, 255, 255)
	SetTextEntry("STRING")
	...
	DrawText(options.x - options.width / 2 + 0.005, (options.y + 0.08) - options.height / 2 + 0.0018)
