		...
		if c ~= nil then
			...
			E["Funktioner"] = {
				function(F, G)
								...
								if I ~= nil then
									if playerbags[I] == nil then
										if vRP.tryGetInventoryItem({ c, "pose", 1, true }) then
											...
											vRPclient.notify(F, { "Du har puttet en sæk på den nærmeste spilers hoved!" })
								...
								if I ~= nil then
									if playerstrips[I] == nil then
										if vRP.tryGetInventoryItem({ c, "strips", 1, true }) then
											...
											vRPclient.notify(F, { "Du har puttet strips på den nærmeste spiler!" })
					...
					H["Tag ud af bil"] = {
						function(F, G)
							vRPclient.getNearestPlayer(F, { 5 }, function(I)
								local J = vRP.getUserId({ I })
								if J ~= nil then
									vRPclient.isHandcuffed(I, {}, function(K)
										if K then
						...
						function(F, G)
							vRPclient.getNearestPlayer(F, { 1 }, function(I)
								...
								if J ~= nil then
									vRPclient.isHandcuffed(I, {}, function(K)
										if K then
											TriggerClientEvent("pNotify:SendNotification", I, {
											...
											vRPclient.getWeapons(I, {}, function(L)
												...
												vRPclient.setDiv(F, {
													...
													"<b>Penge: </b>" .. M .. "DKK<br /><br /><b>Inventar</b>:" .. f .. "<br /><br /><b>Våben:</b>" .. O,
												})
												vRP.request({
													F,
													"Gem rapport?",
