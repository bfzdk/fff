				...
				local ontexture = function(player, choice)
					...
					vRP.getUData({
						...
						function(value_t)
							...
							custom[tostring(parts[choice])] =
								{ drawables[choice][1], custom[tostring(parts[choice])][2], textures[choice][1] }
...
local ch_display_custom = {
	function(player, choice)
		local custom = vRPbs.getOverlay(player)
			or {--[[
	[0] = {255,0,0},
	[1] = {255,1,0},
	[2] = {255,1,0},
