		...
		if supported(Vehicle) then
			if GetPedInVehicleSeat(Vehicle, -1) == PlayerPedId() then
				if autopilot == true then
					...
					drawTxt(0.740, 1.355, 1.0, 1.0, 0.45, "~w~TRYK PIL OP/NED FOR FART", 255, 0, 0, 255)
					drawTxt(0.740, 1.330, 1.0, 1.0, 0.45, "~w~FART: ~y~" .. speed .. "~w~ KM/T", 255, 0, 0, 255)
					drawTxt(0.740, 1.395, 1.0, 1.0, 0.45, "~g~AUTOPILOT", 255, 0, 0, 255)
				...
				elseif autopilot == false then
					drawTxt(0.660, 1.345, 1.0, 1.0, 0.45, "~w~TRYK X FOR ~r~AUTOPILOT", 255, 0, 0, 255)
					if IsControlJustPressed(0, 73) then
						autopilot = true
						lastcoords = ""
						speed = 0
