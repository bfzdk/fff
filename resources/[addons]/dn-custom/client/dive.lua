...
AddEventHandler("dive:water", function()
	...
	if IsEntityInWater(ped) then
		...
		TriggerEvent(
			...
			{
				text = "Du skal være i vandet før du kan tage dykker dragt på.",
				type = "success",
				timeout = 2000,
				layout = "centerLeft",
				queue = "global",
			...
			if breathrounded <= 0 then
				...
				if breathrounded <= 6 then
					drawTxt(
						...
						1.0,
						0.45,
						"~r~" .. breathrounded .. " sekunder tilbage under vandet",
						255,
						255,
						255,
						240
				...
				elseif breathrounded > 6 and breathrounded < 12 then
					drawTxt(
						...
						1.0,
						0.45,
						"~y~" .. breathrounded .. " sekunder tilbage under vandet",
						255,
						255,
						255,
						240
					...
					drawTxt(
						...
						1.0,
						0.45,
						"~w~" .. breathrounded .. " sekunder tilbage under vandet",
						255,
						255,
						255,
						150
