	...
	if antal == 0 then
		if user_id ~= nil then
			...
			PerformHttpRequest(
				...
				"POST",
				json.encode({ username = "FlaxHosting - Logs", content = "ID: " .. user_id .. " modtog kørekort" }),
		...
		PerformHttpRequest(
			...
			json.encode({
				...
				content = "ID: "
					.. user_id
					.. " forsøgte at misbruge kørekort med "
					.. antal
					.. " via "
...
local choice_asklc = {
	...
	"Tjek kørekort på nærmeste spiller.",
}
