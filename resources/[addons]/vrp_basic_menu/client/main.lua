	...
	Citizen.CreateThread(function()
		...
		if DoesEntityExist(vehicleHandle) then
			...
			TriggerEvent(
				"pNotify:SendNotification",
				{
					text = "For langt væk fra Køretøjet!",
					type = "info",
					queue = "global",
					timeout = 5000,
					layout = "centerRight",
...
function vRPbm.deleteVehicleInFrontOrInside(offset)
	...
	if IsEntityAVehicle(veh) then
		...
		TriggerEvent(
			"pNotify:SendNotification",
			{
				text = "For langt væk fra et køretøj!",
				type = "warning",
				queue = "global",
				timeout = 5000,
				layout = "centerRight",
