...
local garages = {
	[1] = { locked = false, camera = {x = -330.945, y = -135.471, z = 39.01, heading = 102.213}, driveout = {x = -350.376,y = -136.76, z = 38.294, heading = 70.226}, drivein = {x = -350.655,y = -136.55, z = 38.295, heading = 249.532}, outside = { x = -362.7962, y = -132.4005, z = 38.25239, heading = 71.187133}, inside = {x = -337.3863,y = -136.9247,z = 38.5737, heading = 269.455, hidden = false}},
	[2] = { locked = false, camera = {x = 737.09, y = -1085.721, z = 22.169, heading = 114.86}, driveout = {x = 725.46,y = -1088.822, z = 21.455, heading = 89.395}, drivein = {x = 726.157, y = -1088.768, z = 22.169, heading = 270.288}, outside = {x = 716.54,y = -1088.757, z = 21.651, heading = 89.248}, inside = {x = 733.69,y = -1088.74, z = 21.733, heading = 270.528, hidden = false}},
	[3] = { locked = false, camera = {x = -1154.902, y = -2011.438, z = 13.18, heading = 95.49}, driveout = {x = -1150.379,y = -1995.845, z = 12.465, heading = 313.594}, drivein = {x = -1150.26,y = -1995.642, z = 12.466, heading = 136.859}, outside = {x = -1140.352,y = -1985.89, z = 12.45, heading = 314.406}, inside = {x = -1155.077,y = -2006.61, z = 12.465, heading = 162.58, hidden = false}},
	[4] = { locked = false, camera = {x = 1177.98, y = 2636.059, z = 37.754, heading = 37.082}, driveout = {x = 1175.003,y = 2642.175, z = 37.045, heading = 0.759}, drivein = {x = 1174.701,y = 2643.764, z = 37.048, heading = 178.119}, outside = {x = 1175.565,y = 2652.819, z = 37.941, heading = 351.579}, inside = {x = 1174.823,y = 2637.807, z = 37.045, heading = 181.19, hidden = false}},
	[5] = { locked = false, camera = {x = 105.825, y = 6627.562, z = 31.787, heading = 266.692}, driveout = {x = 112.326,y = 6625.148, z = 31.073, heading = 224.641}, drivein = {x = 112.738,y = 6624.644, z = 31.072, heading = 44.262}, outside = {x = 118.493,y = 6618.897, z = 31.13, heading = 224.701}, inside = {x = 108.842,y = 6628.447, z = 31.072, heading = 45.504, hidden = false}},
	[6] = { locked = false, camera = {x = -215.518, y = -1329.135, z = 30.89, heading = 329.092}, driveout = {x = -205.935,y = -1316.642, z = 30.176, heading = 356.495}, drivein = {x = -205.626,y = -1314.99, z = 30.247, heading = 179.395}, outside = {x = -205.594,y = -1304.085, z = 30.614, heading = 359.792}, inside = {x = -212.368,y = -1325.486, z = 30.176, heading = 141.107, hidden = false} },
	[7] = { locked = false, camera = {x = 877.441, y = -3246.062, z = -98.285, heading = 88.726}, driveout = {x = 873.132,y = -3245.980, z = -98.288, heading = 88.944}, drivein = {x = 869.336,y = -3245.908, z = -98.291, heading = 88.961}, outside = {x = 865.545,y = -3245.993, z = -98.294, heading = 90.494}, inside = {x = 860.964,y = -3246.108, z = -98.294, heading = 90.762, hidden = false} },
	[8] = { locked = false, camera = {x = -1755.092, y = 3049.597, z = 34.454, heading = 143.840}, driveout = {x = -1755.461,y = 3056.094, z = 32.825, heading = 326.187}, drivein = {x = -1759.247,y = 3058.229, z = 32.823, heading = 187.599}, outside = {x = -1752.709,y = 3058.762, z = 32.829, heading = 298.531}, inside = {x = -1758.556,y = 3050.991, z = 32.818, heading = 185.213, hidden = true} }
}
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		if vRPex.getAmountOnline({"mechanic"}) > 0 then
			--Calculate price for vehicle repair and add repair  button. Hvis der er en mekaniker på arbejde.
			local maxvehhp = 1000
			local damage = 0
			damage = (maxvehhp - GetVehicleBodyHealth(veh))/1
			LSCMenu:addPurchase("Reparer køretøj",round(250+150+1700*damage,0), "Ring til en mekaniker for et bedre tilbud.")
		else
			--]]
			--Calculate price for vehicle repair and add repair  button. Hvis der ikke er en mekaniker på arbejde.
			local maxvehhp = 1000
			local damage = 0
			local PedVeh = GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1)))
			damage = (maxvehhp - GetVehicleBodyHealth(PedVeh))/10
			LSCMenu:addPurchase("Reparer køretøj",round(10000,0), "Fuld køretøjs reparation og motor tjek.")
		end
...
function CheckVehicle(Veh)
    if Veh == 'SANCHEZ01' then
        return 'SANCHEZ'
    elseif Veh == 'STREITER' then
        local vehicle = GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1)))
        return streither[tostring(vehicle)]
    elseif Veh == 'BUFFALO02' then
        return 'BUFFALO2'
    else
        return Veh
    end
...
local function DriveOutOfGarage(pos)
	Citizen.CreateThread(function()
		...
		local ok, model, veh_type = GetVehiclePedIsUsing(ped) --vRP.getNearestOwnedVehicle({1})
...
--print(playerVeh .. ' - '  .. VehicleModel .. ' - '  .. VehicleNameLabel .. ' - '  .. VehicleName) --debug
		...
		if ok then
			TriggerServerEvent("LSC:finished", VehicleModel, plate, myveh, myveh.color[1], myveh.color[2])
		end
						...
						if LSC_Config.oldenter then
							...
							if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(5) then
								...
								if not tableContains(LSC_Config.ModelBlacklist,GetDisplayNameFromVehicleModel(GetEntityModel(veh)):lower()) then
									...
									if pos.locked then
										...
										if not LSC_Config.lock then
											if IsControlJustPressed(1,38) then
												...
												drawTxt("~b~[E]~w~ - Tilgå Los Santos Customs",4,1,0.5,0.8,1.0,255,255,255,255)
												DrawMarker(30, outside.x,outside.y,outside.z, 0,0,0,0,0,0,1.0001,1.0001,1.0001, 143, 32, 183, 180,0,0,0,10)
											end
										else
											drawTxt("~r~Låst, vent venligst",4,1,0.5,0.8,1.0,255,255,255,255)
										end
									else
										if IsControlJustPressed(1,38) then
											inside = true
									...
									drawTxt("~r~Dette køretøj kan ikke opgraderes",4,1,0.5,0.8,1.0,255,255,255,255)
								end
							end
						else
...
function LSCMenu:onSelectedIndexChanged(name, button)
	...
	elseif m == "neon color" then
		if myveh.neon then
			...
			LSCMenu:showNotification("~r~Du har ikke neonlys installeret.")
		end
	elseif m == "xenon color" then
		if myveh.mods[22].mod == 1 then
			SetVehicleHeadlightsColour(veh, button.xenon)
		else
			LSCMenu:showNotification("~r~Du har ikke xenon forlygter installeret.")
		end
...
function LSCMenu:onButtonSelected(name, button)
	...
	elseif mname == "xenon color" then
		if myveh.mods[22].mod ~= 1 then
			LSCMenu:showNotification("~r~YDu har ikke xenon forlygter installeret.")
			return
		end
	end
...
function CanPurchase(price, canpurchase)
	if canpurchase then
		if LSCMenu.currentmenu == "main" then
			LSCMenu:showNotification("Dit køretøj er blevet repareret")
		else
			LSCMenu:showNotification("Del Købt.")
		end
		return true
	else
		LSCMenu:showNotification("~r~Du har ikke råd til dette køb.")
		return false
	end
end
...
Citizen.CreateThread(function()
	for i,pos in ipairs(garages) do
	   if pos.inside.hidden == true then
   else
